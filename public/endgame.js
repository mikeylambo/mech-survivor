...
{id:'clean-frame',name:'CLEAN FRAME',desc:'Clear an orbit without taking an Eclipse.',reward:'Reliquary + Configuration clue',check:s=>!!s.won&&!(s.corruption>0)},
...
{id:'opportunist',name:'OPPORTUNIST',desc:'Complete every Director opportunity offered in a sortie.',reward:'Stardust quality boost',check:s=>(s.directorHistory||[]).length>=3&&(s.directorHistory||[]).every(x=>x.success!==false)},
...
{id:'redline',name:'REDLINE',desc:'+enemy tempo · +stardust quality',mods:{enemyRate:.82,salvageLuck:.18}},
...
{id:'starved',name:'STARVED REACTOR',desc:'slower XP · stronger Alignments',mods:{xp:.78,blessingPower:1.25}},
{id:'blight-tide',name:'ECLIPSE TIDE',desc:'corruption arrives early · Reliquary doubled',mods:{corruptionLead:45,reliquary:2}},
{id:'commander-law',name:'COMMANDER LAW',desc:'commander phases gain extra pressure · commander stardust improved',mods:{bossPressure:1.35,bossLoot:.25}}
];
export const ENDGAME_TIERS=[
{id:'circuit-1',name:'SOVEREIGN CIRCUIT I',requires:{campaignClears:1},mutators:['redline'],desc:'Replay the five-orbit descent under REDLINE.'},
