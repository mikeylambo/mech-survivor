...
export const SALVAGE_SLOTS=[
 {id:'weapon',label:'WEAPON ASSEMBLY'},{id:'core',label:'REACTOR CORE'},{id:'armor',label:'ARMOR PLATE'},
 {id:'mobility',label:'MOBILITY RIG'},{id:'support',label:'SUPPORT MODULE'},{id:'relic',label:'RELIC INTERFACE'}
];
export const SALVAGE_RARITIES=[
 {id:'common',label:'STANDARD',weight:62,value:1},{id:'rare',label:'REFINED',weight:25,value:3},
 {id:'epic',label:'EXALTED',weight:10,value:8},{id:'mythic',label:'SOVEREIGN',weight:3,value:20}
];
export const SALVAGE_AFFIX_CONTRACTS=[
 {id:'output',label:'OUTPUT',stat:'damage'},{id:'tempo',label:'TEMPO',stat:'rate'},{id:'integrity',label:'INTEGRITY',stat:'hp'},
 {id:'reach',label:'REACH',stat:'area'},{id:'recovery',label:'RECOVERY',stat:'regen'},{id:'fortune',label:'FORTUNE',stat:'salvage'}
];
...
export function salvageSummary(item){return `${item.rarityLabel} · T${item.tier} · ${item.familyName||item.slotLabel}`}
