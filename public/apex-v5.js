import {evolveCreatureGenome} from './species-v5.js';
...
export function createApexGenome(base,{seed=`${base.seed}:apex`,mutation='auto'}={}){
 ...
 if(apex==='wing-mantle'){g.signature.motif='wing-fins';g.signature.magnitude*=1.55;g.apex.phaseGenes=['strafe','swoop','storm'];g.stats.speed=(g.stats.speed||1)*1.16;g.stats.projectiles=(g.stats.projectiles||0)+1}
 ...
 if(apex==='siege-limbs'){if(g.bodyPlan==='humanoid')g.anatomy.structure.oversizedLimb=true;g.signature.secondary='shoulder-spikes';g.apex.phaseGenes=['slam','lance','ram'];g.stats.contact=(g.stats.contact||1)*1.35;g.stats.damage*=1.15}
